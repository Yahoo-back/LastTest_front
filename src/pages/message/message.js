...
import { Input, Button, Icon, message, Alert } from 'antd';
  ...
  render() {
    return (
      <div className="message">
        <Alert showIcon={false} className="alert" message="为了Young菜谱网更好地发展，提出您宝贵的意见吧！" banner />
        <div>
          <Input
        ...
        <div className="submit">
          <Button loading={this.state.isLoading} style={{ width: '100%' }} type="primary" onClick={this.handleOk}>
            提交
          </Button>
        </div>
      </div>
